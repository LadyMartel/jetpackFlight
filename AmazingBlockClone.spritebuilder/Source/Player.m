...
-(void)fly:(int)direction{
    CCAnimationManager * animManager = self.animationManager;
    [animManager runAnimationsForSequenceNamed:@"playerRocketBoost"];
    [self.physicsBody setVelocity:ccp(0,0)];
    [self.physicsBody applyImpulse:ccp(direction * 10, 1000)];
}
